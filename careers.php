        ...
        <div class="container">
            ...
            <div class="row mb-20px">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <a class="btn btn-block" data-toggle="modal" data-target="#appModal">Apply Now</a>
                </div>
            ...
            ====================================================-->
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#appModal">Large modal</button>
            <?php
